...
2. ~~camera is a global right now in the window class, this is not a desired state, we should be creating the camera in the main function or somewhere else, will try to make this change soon.~~
